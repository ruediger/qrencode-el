...
** Installation
  ...
  [[https://elpa.gnu.org/packages/qrencode.html][file:https://elpa.gnu.org/packages/qrencode.svg]]
  ...
  QREncode is available via [[https://elpa.gnu.org/packages/qrencode.html][GNU ELPA]], [[https://melpa.org/#/qrencode][MELPA,]] and [[https://github.com/dimitri/el-get/blob/master/recipes/qrencode.rcp][el-get]].
